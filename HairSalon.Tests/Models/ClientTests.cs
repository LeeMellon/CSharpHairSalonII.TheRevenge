...
namespace HairSalon.Tests
{
  ...
  public class ClientTest : IDisposable
  {
    ...
    [TestMethod]
    public void AddStylist_ReturnInt_Int()
    {
      //arrange
      Client newClient1 = new Client("Franz", "Franzia", 5031112222, "franz@franzia.org");
      Stylist newStylist = new Stylist ("Berly", 3);
      newClient1.Save();
      newStylist.Save();
      ...
      int clientStylistId = newClient1.GetStylistId();

      //assert
      Console.WriteLine("TEST sytlist ID: " + stylistId);
      Assert.AreEqual(stylistId, clientStylistId);
    }
  }
}
